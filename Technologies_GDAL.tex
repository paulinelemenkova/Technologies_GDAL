...
The plotting was done by the code: $‘r.slope.aspect elevation=ETOPO1\_KKT\_WGS84 \\slope=slope aspect=aspect pcurvature=pcurv tcurvature=tcurv’$, where the input elevation raster map is the ETOPO1\_KKT\_WGS84, and the output raster map is ‘slope’. The results include the morphometric elements of slope, aspect, profile curvature and tangential curvature, Figure \ref{Fig:9}.
